 ...
 * 
 */
class Acicrud extends CI_Model {
	...
	* PHP5 constructor.
	* 
	* Not directly used for legacy compatibility.
	* 
	...
	*/
	 ...
	 * @return Acicrud
	 */
    public function Acicrud($table = null, $database = null)
    {
        parent::__construct();
	...
	*/
    public function create($o)
    {
        foreach($this->fields as $k => $v)
        {
            if(isset($o->$k)) // Prevent emptys id's
            {
                $this->o_db->set($k, $o->$k);    
            }
        }       
        ...
        if($this->o_db->insert($this->table) === TRUE) {
	        ...
	        {
	            throw new Exception('CREATE_' . $this->table . '_ERROR');
	        }        	
        }
	...
	*/
    ...
    {       
    	foreach($o as $k => $v) {	
    		...
    		//Checks if the field given by $o exist
	...
	* @return collection
	*/
	public function getAll($limit = null, $order = null, $where = null)
	 ...
	 * @return collection
	 */
	public function getBy($by = null, $value = '') {
