...
--
-- Host: localhost
-- Generation Time: Jan 09, 2014 at 11:56 AM
...
-- Database: `oap_se`
--
CREATE DATABASE IF NOT EXISTS `oap_se` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `oap_se`;
...
CREATE TABLE IF NOT EXISTS `connector_map` (
  ...
  `connector1` varchar(25) NOT NULL,
  `connector2` varchar(25) NOT NULL,
